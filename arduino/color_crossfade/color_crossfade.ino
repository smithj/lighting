...
int hold = 60;       // Optional hold when a color is complete, before the next crossFade
...
void crossFade(int color[3]) {
  // Convert to 0-255
  int R = (color[0] * maxBright) / 100;
  int G = (color[1] * maxBright) / 100;
  int B = (color[2] * maxBright) / 100;
